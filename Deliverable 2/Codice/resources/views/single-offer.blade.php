  ...
  <body>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4"><span>{{$offer->titolo}}</span></h2>
        </div>
        <div>
                  <p>{{ $offer->descrizione }}</p>
                  <span class="bg-info text-white badge py-2 px-3"> Contratto : {{$offer->tipocontratto}}</span>
                  <span class="bg-secondary text-white badge py-2 px-3"> Stipendio : {{$offer->stipendio}}</span>
    ...
    for($i=0;$i<count($candidature);$i++){ ?>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <h3 class="mb-4">{{$candidature[$i]->punteggio}}/5</h3>
                    <p class="name">{{$candidature[$i]->name}} {{$candidature[$i]->cognome}}</p>
                    <span class="position">{{$candidature[$i]->titolostudio}}</span>
                  </div>
                </div>
              </div>
            <?php } ?>
...
<form action="{{ route('candidaturestore')}}" method="post" class="p-5 bg-white">
   ...
   <label class="font-weight-bold" for="titolostudio">Study Title</label>
     <div class="col-md-12 mb-3 mb-md-0">
       <input type="text" value="{{$user->titolodistudio}}" readonly="readonly" class="form-control" name="titolostudio" placeholder="Years">
     </div>
   </div>
       </div>
   </div>
   ...
   <label class="font-weight-bold" for="eta">Age</label>
     <div class="col-md-12 mb-3 mb-md-0">
       <input type="text" value="{{$user->eta}}" readonly="readonly" class="form-control" name="eta" placeholder="Years">
     </div>
   </div>
   ...
   <input style="visibility: hidden;" type="text" value="{{$offer->id}}" class="form-control" name="offer_id" placeholder="Years">
