  ...
  <body>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4"><span>{{$user->name}} {{$user->cognome}}</span></h2>
        </div>
        <div>
                  
                  <span class="bg-info text-white badge py-2 px-3"> </span>
                  <span class="bg-secondary text-white badge py-2 px-3"> </span>
