			          ...
			          <div class="col-md-12 tab-wrap">
			            ...
			            <div class="tab-content p-4" id="v-pills-tabContent">
			              ...
			              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
			              	<form action="<?php echo e(route('search-offers')); ?>" method="GET" class="search-job">
			              		<div class="row">
			              			<div class="col-md">
			              				<div class="form-group">
				              				<div class="form-field">
				              					<div class="icon"><span class="icon-briefcase"></span></div>
								                <input type="text" class="form-control" name="titolo" placeholder="eg. Garphic. Web Developer">
								              </div>
							              </div>
			              			</div>
			              			<div class="col-md">
			              ...
			              <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-performance-tab">
			              	<form action="<?php echo e(route('search-users')); ?>" method ="GET" class="search-job">
			              		<div class="row">
			              			<div class="col-md">
			              				<div class="form-group">
				              				<div class="form-field">
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    ...
                    <p class="name"><a href="<?php echo e(url("/$user->email")); ?>"> <?php echo e($user->name); ?> <?php echo e($user->cognome); ?> </a> </p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prova\resources\views/search-users-results.blade.php ENDPATH**/ ?>