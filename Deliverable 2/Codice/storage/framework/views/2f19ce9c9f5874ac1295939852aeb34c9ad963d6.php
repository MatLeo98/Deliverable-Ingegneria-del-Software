      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">Job Offer Title</label>
              ...
              <div class="row form-group mb-5">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="stipendio" class="form-control" placeholder="1500">
                </div>
              </div>
...
<?php /**PATH C:\xampp\htdocs\prova\resources\views/new-post.blade.php ENDPATH**/ ?>