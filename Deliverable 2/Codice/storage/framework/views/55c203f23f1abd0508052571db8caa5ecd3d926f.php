      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
			     ...
			     <form action="<?php echo e(route('offerstore')); ?>" method="post" class="p-5 bg-white">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prova\resources\views/new-offer.blade.php ENDPATH**/ ?>