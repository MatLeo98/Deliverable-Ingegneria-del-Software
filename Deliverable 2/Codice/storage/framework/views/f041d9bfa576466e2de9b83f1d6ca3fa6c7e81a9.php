		...
		<section class="ftco-section bg-light">
         ...
         <div class="col-md-12 ftco-animate">
						<div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
						  ...
						  <div class="mb-4 mb-md-0 mr-5">
						   <div class="job-post-item-header d-flex align-items-center">
						     <h2 class="mr-3 text-black h4"> <?php echo e($offers->titolo); ?> </h2>
						     <div class="badge-wrap">
						   ...
						   <div class="job-post-item-body d-block d-md-flex">
						     ...
						     <div><span class="icon-my_location"></span> <span><?php echo e($offers->luogo); ?></span></div>
						   </div>
						  </div>

						  <div class="ml-auto d-flex">
						  	<a href="<?php echo e(url("/$offers->id")); ?>" class="btn btn-primary py-2 mr-1"> Open Offer </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prova\resources\views/index.blade.php ENDPATH**/ ?>